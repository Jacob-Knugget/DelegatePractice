...
namespace assignment8ex1
{
    class Program
    {
        ...
        {
            SongDelegate lyricDelegate = new SongDelegate(HereComesTheSun.chorus);
            lyricDelegate += HereComesTheSun.verse1;
            lyricDelegate += HereComesTheSun.chorus;
            lyricDelegate += HereComesTheSun.verse2;
            lyricDelegate += HereComesTheSun.chorus2;
            lyricDelegate += HereComesTheSun.verse3;
            lyricDelegate += HereComesTheSun.chorus;
            lyricDelegate += HereComesTheSun.chorus;
            lyricDelegate += HereComesTheSun.end;
